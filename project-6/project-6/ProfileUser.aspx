      ...
      <div class="panel">
          ...
          <div class="panel-body bio-graph-info">
             ...
             <div id="userEdit" runat="server">
                  <div class="row" >
                      <div class="bio-row">
                          <p><span> Name </span><asp:TextBox CssClass="form-control" ID="name2" runat="server"></asp:TextBox></p>
                      ...
                      <asp:FileUpload ID="FileUpload1" runat="server" /><asp:Button ID="Button2" runat="server" Text="Upload" OnClick="Button2_Click" />
                  </div>
